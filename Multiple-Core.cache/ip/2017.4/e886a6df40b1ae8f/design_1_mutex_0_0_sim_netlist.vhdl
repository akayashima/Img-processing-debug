...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Gen_DRAM is
  port (
    ...
    \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_decode is
  port (
    ...
    \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\ : out STD_LOGIC_VECTOR ( 5 downto 0 );
    \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\ : out STD_LOGIC_VECTOR ( 8 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_decode is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Mutex_Addr_I[0]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[3]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[9]_i_1\ : label is "soft_lutpair16";
...
\Mutex_Wr_Data_I_reg[23]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(8),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(8),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[24]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(7),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(7),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[25]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(6),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(6),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[26]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(5),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(5),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[27]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(4),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(4),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[28]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(3),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(3),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[29]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(2),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(2),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[30]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(1),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(1),
      R => SR(0)
    );
\Mutex_Wr_Data_I_reg[31]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => Mutex_Access_I0,
      D => S0_AXI_WDATA(0),
      Q => \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(0),
      R => SR(0)
    );
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_decode__parameterized1\ is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Mutex_Addr_I[0]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[2]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[3]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[8]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[9]_i_1\ : label is "soft_lutpair20";
  attribute box_type : string;
  attribute box_type of \S_AXI_RDATA_DFF[0].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute box_type of \S_AXI_RDATA_DFF[1].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute box_type of \S_AXI_RDATA_DFF[2].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  ...
  attribute box_type of \S_AXI_RDATA_DFF[7].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute box_type of \S_AXI_RDATA_DFF[8].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute SOFT_HLUTNM of new_read_access_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of new_write_access_cmb : label is "soft_lutpair19";
begin
...
\Use_Multi_Ch_Reg.RAM_Storage\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Gen_DRAM
     port map (
      ...
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(3 downto 0) => \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(3 downto 0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mutex_core is
  port (
    ...
    Mutex_Addr : in STD_LOGIC_VECTOR ( 11 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mutex_core is
  ...
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Addr_I[0]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Addr_I[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Addr_I[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Addr_I[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Addr_I[8]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[26]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[27]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[28]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[29]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[30]_i_1\ : label is "soft_lutpair12";
...
\No_HW_Protection.Normal_Mutex_Inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_multi_channel_mutex
     port map (
      ...
      S0_AXI_ACLK => S0_AXI_ACLK,
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(3 downto 0) => a(3 downto 0),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(8 downto 0) => Mutex_Wr_Data_I(8 downto 0),
      Write_Strobe => Write_Strobe
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mutex is
  ...
  signal Mutex_Access : STD_LOGIC;
  signal Mutex_Ack : STD_LOGIC_VECTOR ( 0 to 1 );
  signal Mutex_Addr : STD_LOGIC_VECTOR ( 0 to 21 );
...
SingleAccess: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mutex_core
     port map (
      ...
      Mutex_Access => Mutex_Access,
      Mutex_Access_I_reg => \Using_AXI_1.AXI_If_1_n_11\,
      Mutex_Ack(0 to 1) => Mutex_Ack(0 to 1),
      Mutex_Addr(11) => Mutex_Addr(0),
      Mutex_Addr(10) => Mutex_Addr(1),
      Mutex_Addr(9) => Mutex_Addr(2),
      Mutex_Addr(8) => Mutex_Addr(3),
      Mutex_Addr(7) => Mutex_Addr(8),
      Mutex_Addr(6) => Mutex_Addr(9),
      Mutex_Addr(5) => Mutex_Addr(12),
      Mutex_Addr(4) => Mutex_Addr(13),
      Mutex_Addr(3) => Mutex_Addr(14),
      Mutex_Addr(2) => Mutex_Addr(15),
      Mutex_Addr(1) => Mutex_Addr(20),
      Mutex_Addr(0) => Mutex_Addr(21),
      Mutex_RnW_I_reg => \Using_AXI_0.AXI_If_0_n_14\,
...
\Using_AXI_0.AXI_If_0\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_decode
     port map (
      ...
      SR(0) => Rst,
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(5) => Mutex_Addr(0),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(4) => Mutex_Addr(1),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(3) => Mutex_Addr(2),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(2) => Mutex_Addr(3),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(1) => Mutex_Addr(8),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(0) => Mutex_Addr(9),
      \Using_MultiIf_Mutex.Mutex_RnW_I_reg\ => \Using_AXI_0.AXI_If_0_n_14\,
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(8) => Mutex_Wr_Data(23),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(7) => Mutex_Wr_Data(24),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(6) => Mutex_Wr_Data(25),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(5) => Mutex_Wr_Data(26),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(4) => Mutex_Wr_Data(27),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(3) => Mutex_Wr_Data(28),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(2) => Mutex_Wr_Data(29),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(1) => Mutex_Wr_Data(30),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(0) => Mutex_Wr_Data(31)
    );
\Using_AXI_1.AXI_If_1\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_decode__parameterized1\
     port map (
      ...
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(5) => Mutex_Addr(12),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(4) => Mutex_Addr(13),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(3) => Mutex_Addr(14),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(2) => Mutex_Addr(15),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(1) => Mutex_Addr(20),
      \Using_MultiIf_Mutex.Mutex_Addr_I_reg[0]\(0) => Mutex_Addr(21),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(8) => Mutex_Wr_Data(55),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(7) => Mutex_Wr_Data(56),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(6) => Mutex_Wr_Data(57),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(5) => Mutex_Wr_Data(58),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(4) => Mutex_Wr_Data(59),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(3) => Mutex_Wr_Data(60),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(2) => Mutex_Wr_Data(61),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(1) => Mutex_Wr_Data(62),
      \Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\(0) => Mutex_Wr_Data(63),
      end_write_reg_0 => \Using_AXI_1.AXI_If_1_n_9\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
