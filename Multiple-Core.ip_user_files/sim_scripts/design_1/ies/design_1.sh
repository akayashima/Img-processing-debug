...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Multiple-Core.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Multiple-Core.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"/home/Xilinx/Vivado/2017.4/data/xilinx_vip/include"
}
